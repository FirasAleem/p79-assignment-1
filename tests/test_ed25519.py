...
import os
import hashlib
from x25519.utils import mult_inverse, int_to_bytes
...
class TestEd25519(unittest.TestCase):
    ...
    #     """Test against known RFC 8032 test vectors for Ed25519."""
    ...
    #     self.assertEqual(generated_public_key, public_key)
    ...
    #     expected_signature = bytes.fromhex("92a009a9f0d4cab8720e820b5f642540a2b27b5416503f8fb3762223ebdb69da085ac1e43e15996e458f3613d0f11d8c387b2eaeb4302aeeb00d291612bb0c00")
    ...
    #     # Test Vector 3
    #     private_key = bytes.fromhex("c5aa8df43f9f837bedb7442f31dcb7b166d38535076f094b85ce3a2e0b4458f7")
    #     public_key = bytes.fromhex("fc51cd8e6218a1a38da47ed00230f0580816ed13ba3303ac5deb911548908025")
    #     message = bytes.fromhex("af82")
    #     expected_signature = bytes.fromhex("6291d657deec24024827e69c3abe01a30ce548a284743a445e3680d7db5ac3ac18ff9b538d16f290ae67f760984dc6594a7c15e9716ed28dc027beceea1ec40a")

    #     generated_public_key = self.ed25519.generate_public_key(private_key)
    #     self.assertEqual(generated_public_key, public_key)

    #     signature = self.ed25519.sign(private_key, message)
    #     # public_key_generated = self.ed25519.generate_public_key(private_key).hex()
    #     # self.assertEqual(public_key_generated, public_key)
    #     self.assertEqual(signature, expected_signature)
    #     self.assertTrue(self.ed25519.verify(public_key, message, signature))
        
    #     # Test Vector 1024
    #     private_key = bytes.fromhex("f5e5767cf153319517630f226876b86c8160cc583bc013744c6bf255f5cc0ee5")
    #     public_key = bytes.fromhex("278117fc144c72340f67d0f2316e8386ceffbf2b2428c9c51fef7c597f1d426e")
    ...
    #     expected_signature = bytes.fromhex("0aab4c900501b3e24d7cdf4663326a3a87df5e4843b2cbdb67cbf6e460fec350aa5371b1508f9f4528ecea23c436d94b5e8fcd4f681e30a6ac00a9704a188a03")
    ...
    #     # Test Vector SHA(abc)
    #     private_key = bytes.fromhex("833fe62409237b9d62ec77587520911e9a759cec1d19755b7da901b96dca3d42")
    #     public_key = bytes.fromhex("ec172b93ad5e563bf4932c70e1245034c35467ef2efd4d64ebf819683467e2bf")
    #     message = bytes.fromhex("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f")
    #     expected_signature = bytes.fromhex("dc2a4459e7369633a52b1bf277839a00201009a3efbf3ecb69bea2186c26b58909351fc9ac90b3ecfdfbc7c66431e0303dca179c138ac17ad9bef1177331a704")
